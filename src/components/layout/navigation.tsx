    ...
    <div className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-5 lg:px-10">
      <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        <Link href="/" className="h-auto w-auto flex flex-row items-center">
          ...
          <span className="font-bold text-xs lg:text-xl text-transparent uppercase bg-clip-text bg-gradient-to-r from-purple-900 to-cyan-900 dark:from-purple-300 dark:to-cyan-300 ml-[10px] text-gray-700 dark:text-gray-300">
            {`Công đoàn Bình Dương`}
          </span>
        </Link>

        <div className="hidden w-[500px] h-full lg:flex flex-row items-center justify-between lg:mr-20">

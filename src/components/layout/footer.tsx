...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-900 pb-20 lg:pb-0">
          ...
          <div className="mb-6 lg:mb-0">
            <Link href="/" className="flex items-center">
              <Image
                ...
                alt="Logo"
              />
              <span className="self-center text-xl lg:text-2xl uppercase font-semibold whitespace-nowrap dark:text-white">

  ...
  return (
    <>
      <Button
        ...
        type="button"
        className="inline-flex flex-col items-center justify-center px-5 bg-white"
      >
        <FaTachometerAlt className={`font-bold w-8 h-8 mb-1 text-cyan-600`} />
        <span className="sr-only">Bottom Drawer </span>
      </Button>
      <Drawer
        edge
        open={isOpen}
